          ...
          <>
            ...
            >
              ...
              <div className="flex justify-between items-center p-6 border-b border-slate-100 bg-slate-50/50">
                <span className="text-xl font-display font-bold text-slate-900 tracking-tight">MENU</span>
                <button 
                  ...
                  return (
                    <motion.div key={link.name} variants={{
                      ...
                      <Link
                        ...
                        onClick={() => setIsMobileOpen(false)}
                      >
                        {isActive && <span className="w-2 h-2 rounded-full bg-primary mr-3 shadow-[0_0_8px_rgba(239,94,84,0.6)]"></span>}
                        {link.name}
                      </Link>
                    </motion.div>
                  );
